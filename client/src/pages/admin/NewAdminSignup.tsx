    ...
    <div className="h-screen bg-[#848687] flex items-center justify-center"> 
        <div className="w-7/12 h-auto bg-[#1b2a49] flex signup-container">
            ...
            <div className="w-1/2 h-auto bg-[#5eb7b7] flex items-center justify-center flex-col">
                ...
                <p className="text-white w-80 text-center mt-4">Complete your registration to become an admin and manage the platform effectively!</p>
            ...
            <div className="w-1/2 h-full pt-20 pb-20 px-14">
                ...
                {/* Title Section */}
                <h1 className="text-2xl text-left text-[rgba(255, 255, 255, 0.8)] font-sans ">Admin Sign Up</h1>

                {/* Form Section */}
                <form className="flex flex-col items-center mt-12 w-full">

                    {/* First Name Section */}
                    <label htmlFor="fullName" className="w-full text-left text-[rgba(255, 255, 255, 0.8)] text-xs">FULL NAME</label>
                    <input
                        type="text"
                        id="fullName"
                        name="fullName"
                    ...
                    {/* Password Section */}
                    <label htmlFor="confirmPassword" className="mt-6 w-full text-left text-[rgba(255, 255, 255, 0.8)] text-xs">CONFIRM PASSWORD</label>
                    <input
                        type="password"
                        id="confirmPassword"
                ...
                <Link to='/admin/login'>
                    <p className="mt-5 text-[#5eb7b7] text-sm underline">I'm already an admin</p>
                </Link>
            </div>

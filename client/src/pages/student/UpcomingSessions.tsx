        ...
        <div className='w-10/12 h-96 ml-28 mt-8 py-6  space-x-16 flex bg-white' >
                ...
                {/* <div>
                    {loading ? (
                        ...
                        booking.map((session) => (
                        <div key={session._id} className='w-3/12 h-80 ml-20 bg-blue-50 border rounded-md py-4 px-7 space-y-4 '>

                            <p className='text-black font-serif'>{session.sessionId.title}</p>
                            <div className='flex space-x-3 pt-5'>
                                <PhChalkboardTeacher />
                                <p className='text-gray-600 text-sm'>{session.instructorId.firstName} {session.instructorId.lastName}</p>
                            </div>
                            ...
                            <button className='bg-blue-800 text-sm px-4 py-1 rounded-2xl items-center ml-10'>View Details</button>
            ...
            {/* <div className='w-3/12 h-80 ml-20 bg-blue-50 border rounded-md py-4 px-7 space-y-4 '>
                        
                <p className='text-black font-serif'>Learn Typescript</p>

                <div className='flex space-x-3 pt-5'>
                    <PhChalkboardTeacher />
                    <p className='text-gray-600 text-sm'>Sarah Thomson</p>
                </div>
                <hr className='border border-gray-300' />

                <div className='flex space-x-3'>
                    <IcOutlineAccessTime />
                    <p className='text-gray-600 text-sm'>12:00 PM</p>
                </div>
                <hr className='border border-gray-300' />
                ...
                <div className='flex space-x-10'>
                    ...
                    <div >
                        <BxCalendar />
                        <p className='text-gray-600 text-sm'>30 Dec 2024</p>
                    </div>
                </div>

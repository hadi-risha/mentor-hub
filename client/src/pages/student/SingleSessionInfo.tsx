...
const SingleSessionInfo = () => {
    ...
    useEffect(() => {
        async function fetchSession() {
          try {
            const response = await axiosInstance.get(`/student/session/${id}`); // Adjust the endpoint if needed
                ...
                <div className='p-5 bg-white w-full h-1/2 rounded-bl-md rounded-br-md'>
                    ...
                    <div className='flex justify-center mt-5'>
                        <button 
                            ...
                            className='py-1.5 px-5  bg-primary-orange rounded-full text-xs'>Reserve Your session
                        </button>
                    </div>
